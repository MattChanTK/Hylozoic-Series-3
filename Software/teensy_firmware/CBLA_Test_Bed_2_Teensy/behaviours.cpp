...
void Behaviours::fin_arm_test_behaviour(const uint32_t &curr_time){
...
//----- LOW-LEVEL CONTROL -------
void Behaviours::low_level_control_fin_behaviour(){
...
void Behaviours::low_level_control_light_behaviour(){
	//>>>> LIGHT <<<<<
	for (uint8_t j=0; j<NUM_LIGHT;j++){
...
//----- HIGH-LEVEL CONTROL -------
void Behaviours::high_level_control_fin_reflex_behaviour(const uint32_t &curr_time){
...
void Behaviours::high_level_direct_control_fin_arm_behaviour(const uint32_t &curr_time){
...
void Behaviours::high_level_direct_control_fin_arm_behaviour_continuous(const uint32_t &curr_time){
