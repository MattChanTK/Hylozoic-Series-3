...
class CBLATestBed_Triplet(CBLATestBed):
     ...
     def additional_config_routine(self):
        ...
        # import parameters from files
        self.output_param_config_filename = 'CBLATestBed_Triplet_output_config'
        self.input_param_config_filename = 'CBLATestBed_Triplet_input_config'
     ...
     def parse_message_content(self, msg):
        ...
        if self.reply_type == 0:
            ...
            device_offset += 14*CBLATestBed_Triplet.NUM_FIN
     ...
     def _compose_outgoing_msg(self, content):
        ...
        if self.request_type == 'basic':
            ...
            # === LIGHT ===
            device_offset += 8*CBLATestBed_Triplet.NUM_FIN + device_offset
            # (4 bytes each)
...
class CBLATestBed_Triplet_FAST(CBLATestBed_Triplet):

    def additional_config_routine(self):
        self.var_encode_func["int8s"] = self._set_int8_array

        # import parameters from files
        self.output_param_config_filename = 'CBLATestBed_Triplet_FAST_output_config'
        self.input_param_config_filename = 'CBLATestBed_Triplet_FAST_input_config'
